...
<body>
	<div id="main_wrap2" class="wrap">
		...
		<br><br>
		<form action="home_bookmarkON.php" method="get" name="form" id="bookmark_form" class="form">
		...
		<form action="home_bookmarkOFF.php" method="get" name="form" id="bookmark_form" class="form">
   		<input type="hidden" name="userID" value="<?php echo $userID; ?>"/>
   		<input type="hidden" name="jobname" value="<?php echo $jobname; ?>"/>
		<input type="hidden" name="search" value="<?php echo $search_con; ?>"/>
